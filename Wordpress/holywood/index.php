				...
				<div class="pages-header-text">
					<div class="row">
						...
						<div class="col-sm-8  lj-photo-texts center padding-40-mobile">
							...
							<h2><?php if(get_post_meta( $current_blog_page_id, 'holywood_alt_title', true )){ echo get_post_meta( $current_blog_page_id, 'holywood_alt_title', true ); } else { echo ('Our latest news'); } ?></h2>
							<p class="lead-off"><?php if(get_post_meta( $current_blog_page_id, 'holywood_subtitle', true )){
							echo get_post_meta( $current_blog_page_id, 'holywood_subtitle', true ); } ?></p>
							<?php } ?>
